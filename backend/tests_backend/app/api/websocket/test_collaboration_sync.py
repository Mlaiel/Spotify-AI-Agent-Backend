...
def test_collaborationsynchandler_class():
    # Instanciation réelle
    try:
        from backend.app.api.websocket import collaboration_sync
        obj = getattr(collaboration_sync, 'CollaborationSyncHandler')()
